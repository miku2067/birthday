    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Sasmita</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Sasmita's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Ya tho happy SasmitaDay bhe bol sakte hai  💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Miku 💖</h2>
          <p className="final-subtitle">Uff bohot mahenet se banaya hu ye website ab acha sa thanku boldena 😂✨</p>
        </section>
      </div>
